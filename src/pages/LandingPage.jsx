          ...
          <div style={{
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <li><button onClick={() => navigate('/cookies')} style={{ fontSize: '14px', color: 'var(--footer-text)', textDecoration: 'none', transition: 'color 0.2s ease', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'inherit' }} onMouseEnter={(e) => e.target.style.color = 'var(--footer-text-main)'} onMouseLeave={(e) => e.target.style.color = 'var(--footer-text)'}>Politica Cookies</button></li>
              </ul>
            </div>
